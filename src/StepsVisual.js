export default function StepsVisual(props) {
  const complete = `bg-blue-500 text-white rounded-full h-10 w-10 ml-2
      text-4xl text-center`;
  const uncomplete = `bg-gray-200 to-black rounded-full h-10 w-10 ml-2 text-4xl text-center`;
